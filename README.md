...
| Ventilación | 3.1 | &#x1F7E1;&nbsp; El sistema debe abrir/cerrar una compuerta mediante un servomotor. | Falta montar tanto el cooler como el conjunto servo-compuerta. |
| Control de temperatura | 4.1 | &#x1F7E1;&nbsp; El sistema debe regular la temperatura dentro de los límites establecidos. | Falta implementar el módulo Peltier mediante el empleo del módulo L298N (un doble puente H para invertir la polaridad). Posteriormente debe realizarse el montaje mecánico. |
...
<p align="center"><em>Tabla 1: Estado de los requisitos del sistema Mushroomer al 21 de junio de 2025.</em></p>